...
namespace Homeix.Controllers
{
    public class SubscriptionsController : Controller
    {
        ...
        {
            var hOMEIXDbContext = _context.Subscriptions.Include(s => s.Plan).Include(s => s.User);
        ...
        public async Task<IActionResult> Create([Bind("SubscriptionId,UserId,PlanId,StartDate,EndDate,Status")] Subscription subscription)
        {
            ...
            ViewData["PlanId"] = new SelectList(_context.SubscriptionPlans, "PlanId", "PlanId", subscription.PlanId);
